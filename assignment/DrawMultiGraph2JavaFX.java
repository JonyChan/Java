 ...
 *
 */
public class DrawMultiGraph2JavaFX{
	...
	//constructor
	public DrawMultiGraph2JavaFX(List<String> a, List<Double> b, List<Double> c) {
		this.a = a;
		this.b = b;
		this.c = c;	
	}
...
public static void initFX(JFXPanel p,List<String> a, List<Double> b, List<Double> c){
    ...
    aseries.setName("openData");
    bseries.setName("closeData");
...
//      frame.setSize(dim.width/4, dim.height/4);
      frame.setLocation(new Point(dim.width/4, dim.height*3/4));
